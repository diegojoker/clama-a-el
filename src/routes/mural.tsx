    ...
    <div className="mx-auto flex min-h-screen w-full max-w-md flex-col bg-background pb-32">
      ...
      <div className="px-4 pt-2">
        {posts.length === 0 ? (
          ...
          <>
            <div className="-mx-4 mb-3 flex items-center gap-2 overflow-x-auto whitespace-nowrap pl-4 pr-8 pb-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
